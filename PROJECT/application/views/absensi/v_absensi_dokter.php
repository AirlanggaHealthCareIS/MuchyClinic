    ...
    <div class="container-fluid" style = "padding: 10px" >
      <div class="row"> 
        <div class="col-md-6 col-md-offset-3" style="background-color:">
          <h1 class = "text-center">Absensi Dokter</h1>
            ...
            <form class="form-horizontal" action = "<?php echo base_url()?>cabsensi_dokter/validasi" method="post">
            <div class="form-group"> 
            <label for="exampleInputEmail2" class="col-sm-5 control-label"> Nomor Identitas    :</label>
            <div class="col-sm-5">
            <input type="normal" name="id_dokter" class="form-control" id="exampleInputEmail2" placeholder="Id Dokter">
            </div>
          </div>
           ...
           <!--div class="form-group"> 
            ...
            <div class="col-sm-5"> 
            <input type="nomal" name="date_masuk" class="form-control" id="exampleInputEmail2" placeholder="<?php $this->load->helper('date');
